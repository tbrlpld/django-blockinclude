...
from blockinclude.components import Component
...
if TYPE_CHECKING:
    ...
    from blockinclude.typing import RenderContext
...
class TestComponentTag(SimpleTestCase):
    ...
    def set_parent_template(self, template_string: str) -> None:
        template_string = "{% load blockinclude %}" + template_string
    ...
    def test_render_html_return_not_escaped_when_formatted_html(self) -> None:
        self.component.render_html.return_value = format_html(
            "<h1>My component</h1>", []
        )
        self.set_parent_template("{% component my_component %}")
